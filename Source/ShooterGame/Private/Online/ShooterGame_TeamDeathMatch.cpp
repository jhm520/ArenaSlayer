...
bool AShooterGame_TeamDeathMatch::CanDealDamage(class AShooterPlayerState* DamageInstigator, class AShooterPlayerState* DamagedPlayer) const
{
...
bool AShooterGame_TeamDeathMatch::IsWinner(class AShooterPlayerState* PlayerState) const
{
