...
struct FInstantWeaponData
{
	...
	/** Headshot damage modifier, this value is added to HitDamage when the user gets a headshot BOOM HEADSHOT.*/
	UPROPERTY(EditDefaultsOnly, Category = LocationalDamage)
	int32 HeadshotDamageMod;

	/** Headshot damage modifier when the target is at low health (no shields).*/
	UPROPERTY(EditDefaultsOnly, Category = LocationalDamage)
